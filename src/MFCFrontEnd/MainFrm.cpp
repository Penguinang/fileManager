	...
	CCreateContext* pContext)
{
	...
	if (!m_wndSplitter.CreateView(0, 0, RUNTIME_CLASS(CLeftView), CSize(300, 100), pContext) ||
		!m_wndSplitter.CreateView(0, 1, RUNTIME_CLASS(CManagerGUIView), CSize(600, 100), pContext) ||
...
CManagerGUIView* CMainFrame::GetMiddlePane()
{
	CWnd* pWnd = m_wndSplitter.GetPane(0, 1);
	CManagerGUIView* pView = DYNAMIC_DOWNCAST(CManagerGUIView, pWnd);
	return pView;
}
...
void CMainFrame::OnUpdateViewStyles(CCmdUI* pCmdUI)
{
	...
	CManagerGUIView* pView = GetMiddlePane();
...
void CMainFrame::OnViewStyle(UINT nCommandID)
{
	...
	// if the right-hand pane has been created and is a CManagerGUIView,
