...
template <int MaxDepth, int guid> class DebugMessage {
  public:
...
template <int MaxDepth, int guid> int DebugMessage<MaxDepth, guid>::curRecurDepth = 0;
...
//     DebugMessage<4, __LINE__> printer(
...
Updater::Updater(const ExtensionFilter &eFilter, const NameFilter &bFilter)
